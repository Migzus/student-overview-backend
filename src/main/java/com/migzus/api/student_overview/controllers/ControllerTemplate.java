...
// A generalised template class for controllers
// which uses a model class as a basis for models
// this makes it faster to make these general end points

// in the case we need to make a more modular version, we do not use this generalised version, and just create our own with custom endpoints
